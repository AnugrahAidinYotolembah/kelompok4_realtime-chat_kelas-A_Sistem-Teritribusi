...
dataset_path = "/Users/didiyotolembah19gmail.com/Documents/kuliah S2/perkuliahan/sistem teretribusi/realtime_chat/abusive copy.csv"  # Ganti dengan path file CSV Anda
...
async def enter_name():
    with open("/Users/didiyotolembah19gmail.com/Documents/kuliah S2/perkuliahan/sistem teretribusi/realtime_chat/login.html", "r") as file:  # Ganti dengan path yang sesuai
        return file.read()

# Serve the Chat Room page after entering name
@app.get("/chat", response_class=HTMLResponse)
async def chat_room():
    with open("/Users/didiyotolembah19gmail.com/Documents/kuliah S2/perkuliahan/sistem teretribusi/realtime_chat/chat_room.html", "r") as file:  # Ganti dengan path yang sesuai
        return file.read()
